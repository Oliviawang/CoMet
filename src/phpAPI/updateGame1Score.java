...
public class updateGame1Score{
public ArrayList<game2>  game;

public String errorMessage;
public JSONArray jarr;
         public updateGame1Score() {
			// TODO Auto-generated constructor stub
		Log.i("update game1 score", "poo");
	}
    ...
    String flag;
     		...
     		protected String doInBackground(JSONObject... jsonObjects) {
     			...
     			//	uid1=jsonObjects[0].getString("user1_id");
     				...
     				endtime=jsonObjects[0].getString("end_time");
     				score=jsonObjects[0].getString("score");
     				flag=jsonObjects[0].getString("flag");
     				
     				URL url = new URL(
     						"http://10.0.2.2:8081/insert_game1_score.php?score="+score+"&end="+endtime+"&flag="+flag+"&uid="+uid2+"&colid="+col+"");
	...
	public ArrayList<game1> uploadServerData(String uid2,String colid, String score,long time,String flag) {
